...
Version  : 2.2.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/keras_2.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/keras_2.2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1541781005
