...
Version  : 2.2.4.1
Release  : 11
URL      : https://cran.r-project.org/src/contrib/keras_2.2.4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/keras_2.2.4.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554561013
